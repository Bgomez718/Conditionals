...
//          - reduce "health" by 50
    ...
    console.log('...but Feliple, a fellow android shows up to help you escape them')} else {
        '..but Felipe, a fellow android shows up'
    };
...
if(choice == 'run' && randomPerson == 'john'){
    console.log('You run, but John, a human officer with an attitude and a heart of gold, finds you...');
} 
